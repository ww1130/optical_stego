...
with torch.no_grad():
    for epoch in range(epochs):
        ...
        for batch_idx, (host123,flow_gray) in enumerate(dataloader):
            ...
            #stego_noise_dwt = final_yuv_norm_dwt
            ...
            # if(acc>0.98 and mse_pixel_y < 60):
            ...
            if (batch_idx + 1) % print_every_batch == 0:
                ...
                f'codec_y:{mse_video_code_y:.0f},codec_u:{mse_video_code_u:.0f},codec_v:{mse_video_code_v:.0f},alpha:{alpha:.1f}'
                f' acc: {acc:.4f}')
